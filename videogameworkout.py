...
workouts = ["Pushups", "Goblet Squats", "Kettlebell Swings", "Shoulder Press", "Ab Roller",  "Bent Rows", "Shoulder Raises", "Meditation", "Burpees"]
workoutInfo = {}
"""workoutAccumulated = {}
workoutAccumulated = {
...
def main():
    """Controls the flow of the app. Runs immediately"""
    game = ""
    while (game.lower() != 'q'):
...
def rlWorkout(gameInfo):
    """Determines who won the game and calls the appropriate method to generate the workout. Accepts a gameInfo dictionary, which is generated by getStatistics()"""
...
def owWorkout(gameInfo):
    """Determines who won the game and generates a workout. Accepts a gameInfo dictionary, which is generated by getStatistics()"""
...
def nbaWorkout(gameInfo):
    """Determines who won the game and generates a workout. Accepts a gameInfo dictionary, which is generated by getStatistics(). Not being used yet"""
